<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AppHistory.aspx.cs" Inherits="CarSystemTest.Car.AppHistory" %>
    ...
    <div class="formbody">
        ...
        <ul class="seachform">
            ...
            <li>                
                ...
                <label>&nbsp;</label>
                <asp:Button ID="btnBatchApprove" runat="server" CssClass="scbtn" Text="批量核准" OnClick="btnBatchApprove_Click" />
            </li>
        </ul>
        <div style="width: 100%">
            <asp:Repeater ID="rptAppHistory" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        <td style="width:3%;">
                            <asp:CheckBox ID="cbApprove" ToolTip='<%#Eval("BusinessCode") %>' Visible='<%# CheckPrivilege(Eval("BusinessCode"),Eval("FlowStatusCode")) %>' Text="" runat="server"/>
                        </td>
                        <td style="width: 10%;">
                        ...
                        <td style="width: 20%;">
                            ...
                            <asp:ImageButton ID="ImgMap" ImageAlign="absmiddle" ToolTip="行駛軌跡" BorderStyle="None" Visible='<%# IsFinished(Eval("FinishTime")) %>' ImageUrl="../Images/map.gif" Height="18px" Width="18px" PostBackUrl='<%# GetGpsUrl(Eval("BusinessCode")) %>'
                                Style="cursor: pointer;" runat="server" AlternateText="Map" /><label style="display: inline;" runat="server" visible='<%#  IsFinished(Eval("FinishTime")) %>'>行駛軌跡</label>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
